    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Votre compte nageur a été créé avec succès.
          </p>
          <a
            href="/"
            style={{
    ...
    >
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          ...
          >
            Créez votre espace sportif personnel
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                J'accepte le traitement de mes données de santé (HRV, fréquence
                cardiaque, sommeil, RPE) conformément au{" "}
                <a
                  href="/legal/privacy"
                  target="_blank"
          ...
          <button
            ...
            style={{
              ...
              boxShadow: chargement ? "none" : "0 4px 14px rgba(0,85,255,0.3)",
              transition: "all 0.2s ease",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
